...
const Row = ({arr, style}) =>
  <div className="row">
    ...
    <div className="column" style={style}> {arr[1]} </div>
    <div className="column" style={style}> {arr[2]} </div>
    <div className="column" style={style}> {arr[3]} </div>
  </div>
    ...
    return (
      <div className="column" style={this.props.style} onClick={this.clicked.bind(this)}>
        <div className="ui shape" id={`shapeId${this.props.val}`}>
          <div className="sides">
            <div className="active side">{this.props.val}</div>
            <div className="side"><span style={{color: 'magenta'}}>{this.props.val}</span></div>
          </div>
        </div>
      </div>
    )
